...
namespace _qt_qml_week2_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appweek2)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appweek2))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appweek2)() {
    return 1;
}
